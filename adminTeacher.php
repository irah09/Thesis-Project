...
if(isset($_POST['insertdata']))
{
    ...
    else
    {
        ...
        if ($query_run) {
            ...
            echo "<script>alert('Teacher Unsuccessfully added!');</script>";
            echo  $conn->error;
        }
    }
...
{   
    ...
    if($query_run)
    {
        echo '<script> alert("Teacher Data Updated"); </script>';
...
if(isset($_POST['deletedata']))
{
    ...
    if($query_run)
    {
        echo '<script> alert("Teacher Data Deleted"); </script>';
...
<body>
      ...
      <div class="main-content">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="adminTeacher.php" method="POST" enctype="multipart/form-data"> 
    ...
    <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="adminTeacher.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label> Username </label>
                            <input type="text" name="signup_username" id="uname" class="form-control" placeholder="Enter Username">
                        </div>

                        <div class="form-group">
                            <label> Password </label>
                            <input type="text" name="signup_password" id="password" class="form-control" placeholder="Enter Password ">
                        </div>

                        <div class="form-group">
                            <label> First Name </label>
                            <input type="text" name="signup_firstname" id="fname" class="form-control" placeholder="Enter First Name">
                        </div>

                        <div class="form-group">
                            <label> Middle Name </label>
                            <input type="text" name="signup_middlename" id="mname" class="form-control" placeholder="Enter Middle Name">
                        </div>
                        <div class="form-group">
                            <label> Last Name </label>
                            <input type="text" name="signup_lastname" id="lname"  class="form-control" placeholder="Enter Last Name">
                        </div>
    ...
    <div class="modal fade" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> View Teacher Data </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
              ...
              <div class="container">
                  ...
                  <div class="card">
                      <div class="card-body">
                          ...
                          <center><h4>List of Teachers</h4></center>
                      </div>
                  </div>
                  ...
                  <div class="card">
                      <div class="card-body">
                            ...
                            <?php
                                ...
                                $query = "SELECT uid,username,password,first_name,middle_name,last_name FROM user_table WHERE userlevel = 'Teacher'";
